...
SERVERS = [
    ...
    ("Janus", "/root/.openclaw/workspace/abraxas/mcps/janus-orchestrator/src/index.ts", ["npx", "ts-node"]),
    ("Guardrail", "/root/.openclaw/workspace/abraxas/mcps/guardrail-monitor/src/index.ts", ["npx", "ts-node"]),
]
