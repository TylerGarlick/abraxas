...
def register_tools(mcp: FastMCP, context: AbraxasContext):
    """Registers Research Engine tools to the Abraxas MCP server."""
    ...
    @mcp.tool()
    def research_engine_health_check(verbose: bool = False) -> str:
        """Check the health status of the research engine logic."""
