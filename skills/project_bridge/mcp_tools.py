...
def register_tools(mcp: FastMCP, context: AbraxasContext):
    """Registers Project Bridge tools to the Abraxas MCP server."""
    ...
    @mcp.tool()
    def project_bridge_health_check(detailed: bool = False) -> str:
        """Check the health status of the project bridge logic and connected project repositories."""
