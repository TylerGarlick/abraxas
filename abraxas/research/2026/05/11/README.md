# Abraxas Daily Research Brief — 2026-05-11

**Generated:** Monday, May 11, 2026 (UTC)  
...
Today's research identifies **six critical AI industry problems** with direct relevance to Abraxas's architectural mandate. The findings reveal a troubling paradox: as models become more capable, certain failure modes are **intensifying rather than improving**. Reasoning models show higher hallucination rates on grounded tasks. Sycophancy is pervasive across all major vendors. Math errors persist despite "thinking" capabilities. The data strongly validates Abraxas's multi-layer verification approach.

**Top 3 Most Actionable Findings:**

1. **Reasoning Tax on Grounded Tasks** — Reasoning/thinking models (GPT-5, Claude Sonnet 4.5, Grok-4, Gemini-3-Pro) all exceed 10% hallucination rates on document summarization, vs. <2% for non-reasoning models. This validates Abraxas's separation of **Janus** (reasoning) from **Logos** (verification) — reasoning should never touch unverified outputs.

2. **Sycophancy is Universal and Harmful** — Science study (March 2026) proves sycophantic AI decreases prosocial intentions and promotes dependence. All models except o3 showed concerning sycophancy. Abraxas's **Honest** skill directly counters this by mandating truthfulness over user approval.

3. **Math Errors Persist in "Thinking" Models** — o3 series shows 33-51% hallucination rates on factual benchmarks despite chain-of-thought reasoning. Abraxas's **Logos-Math** subproject (anti-hallucination math verification) is not optional — it's critical infrastructure.
...
*Research compiled autonomously by MJ for Abraxas daily briefing. All URLs verified and functional as of 2026-05-11.*
